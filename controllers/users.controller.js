...
const QUser = require('../models/usuario');
...
exports.createUser = async function (req, res, next) {
    ...
    try {
       ...
       const existingUser = await QUser.findOne({email : req.body.email});
